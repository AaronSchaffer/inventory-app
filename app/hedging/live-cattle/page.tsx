...
export default function LiveCattlePage() {
  ...
  const liveRecords = records.filter(r => r.cattle_type === 'Live Cattle');
  ...
  if (loading) return <LoadingSpinner message="Loading live cattle data..." />;
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-semibold">Live Cattle Hedging</h2>
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200">
            {liveRecords.length === 0 ? (
              <tr><td colSpan={3} className="px-4 py-6 text-center text-gray-500">No live cattle positions found</td></tr>
            ) : (
